# https://community.plone.org/t/plone-app-controlpanel-form-imports-on-plone-5/1208
# according to the above link need to copy paste the form.py from old plone.app.controlpanel and place it here to make it work
# https://raw.githubusercontent.com/plone/plone.app.controlpanel/2.3.x/plone/app/controlpanel/form.py
